...
particle::particle(){
	...
	damping = 0.13f;
	myCharacter = (char)((int)ofRandom(97,122));
}
...
void particle::draw(){
	...
	ofRectangle bounds = myFont->getStringBoundingBox(toDraw, 0, 0);
	
	
	myFont->drawString(toDraw, pos.x - bounds.width/2, pos.y + bounds.height/2);
